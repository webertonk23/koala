...
class Pager {
    ...
    private function getSyntax() {
        $read = new Read;
        $read->FullRead("SELECT id FROM ".$this->Tabela." ".$this->Termos, $this->Places);
        ...
        if ($this->Rows > $this->Limit):
            ...
            $this->Paginator = "<nav class='' aria-label='Page navigation'><ul class='pagination justify-content-center'>";
