						...
						<tbody>
							...
							<?php
								foreach($Fichas as $Values){
									...
									echo (!empty($Values['Ent_ficha']) OR !empty($Values['DesEnt_ficha'])) ? "<td><small>".$Values['Ent_ficha'] ." - ". $Values['DesEnt_ficha']."</small></td>" : "<td></td>";
									echo (!empty($Values['Salario_ficha'])) ? "<td><small>{$Values['Salario_ficha']}</small></td>" : "<td></td>" ;
									echo (!empty($Values['Margem_ficha'])) ? "<td><small>{$Values['Margem_ficha']}</small></td>" : "<td></td>" ;
									echo (!empty($Values['LimiteSaque_ficha'])) ? "<td><small>{$Values['LimiteSaque_ficha']}</small></td>" : "<td></td>" ;
									echo "</tr>";
	...
	<div class="modal fade" id="AddAcionamento" tabindex="-1" role="dialog" aria-labelledby="AddAcionamentolabel" aria-hidden="true">
		  <div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form class="form" method="POST" action="?p=Atendimento\submit2">
					<div class="modal-body">
							<?php
							if(empty($Idficha)){?>
